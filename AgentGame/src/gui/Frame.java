...
public class Frame extends javax.swing.JFrame {
  ...
  boolean gameOver = false, move = true, planTog = true;
  ...
  ImageIcon ninja = new javax.swing.ImageIcon(getClass().getResource("/images/Ninja.png"));
    ...
    private void initComponents() {
        ...
        planCheck = new javax.swing.JCheckBox();
        ...
        Rules.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/menu.png"))); // NOI18N
        emptyPanel.add(Rules);
        ...
        plan.setFont(new java.awt.Font("Tahoma", 0, 18));
        plan.setForeground(new java.awt.Color(255, 255, 0));
        plan.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        newButtonPanel.add(plan);

        planCheck.setBackground(new java.awt.Color(143, 107, 57));
        planCheck.setFont(new java.awt.Font("Tahoma", 0, 18));
        planCheck.setForeground(new java.awt.Color(255, 255, 0));
        planCheck.setSelected(true);
        planCheck.setText("Plan?");
        planCheck.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        planCheck.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                planCheckMouseClicked(evt);
            }
        });
        newButtonPanel.add(planCheck);
        ...
        grid11.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid12.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid13.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid21.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid22.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid23.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid31.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid32.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        grid33.setFont(new java.awt.Font("Tahoma", 0, 36));
  ...
  private void planCheckMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_planCheckMouseClicked
    planTog = planCheck.isSelected();
    game.togglePlan(planTog); 
  }//GEN-LAST:event_planCheckMouseClicked
    ...
    private void showWin(){
      ...
      for(int i = 0; i < win.length; i++){
        ...
        match.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(240, 20, 0), 4, true));
      }
    }
    ...
    private void newGame() {
     ...
     for(int i = 0; i < comps; i++ )
     {
      ...
      ((JLabel)toChange).setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 0), 3, true));
    ...
    private javax.swing.JCheckBox planCheck;
